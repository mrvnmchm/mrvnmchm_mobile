...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("mrvnmchm_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("mrvnmchm.config") // Configuration fileName without the .TOML or .YAML extension
	}
